...
public class TrainManager : NetworkBehaviour
{
    ...
    [SerializeField]
    private GameObject DeffaultWagon;
    [SerializeField]
    private GameObject[] AnomalyWagons;
    [SerializeField]
    private GameObject vestibulePrefab;
    [SerializeField]
    private List<GameObject> trainPool;
    //offsets
    ...
    //current data
    [SerializeField]
    private bool currentWagonHasAnomaly = false;
    ...
    void SetOffsets(WagonController wagonController, VestibuleController vestibuleController, VestibuleType vestibuleType)
    {
